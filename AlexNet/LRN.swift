...
func localResponseNorm<T : FloatingPoint & TensorFlowScalar>(_ input: Tensor<T>, depthRadius: Int64 = 5, bias: Double = 1, alpha: Double = 1, beta: Double = 0.5) -> Tensor<T> {
    return Raw.lRN(input, depthRadius: depthRadius, bias: bias, alpha: alpha, beta: beta)
}

func vjpLocalResponseNorm<T : FloatingPoint & TensorFlowScalar>(_ input: Tensor<T>, depthRadius: Int64 = 5, bias: Double = 1, alpha: Double = 1, beta: Double = 0.5) -> (Tensor<T>, (Tensor<T>) -> (Tensor<T>)) {
